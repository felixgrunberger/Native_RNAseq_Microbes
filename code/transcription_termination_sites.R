...
packages <- c("MASS", "UpSetR","ggseqlogo", "tidyverse", 
              "here", "ggthemes", "data.table", "ggExtra", 
              "Rsamtools", "GenomicAlignments", "seqTools", 
              "Rsubread", "ape", "DT", "ggpubr", "ggridges", 
              "ggsci", "GenomicRanges","IRanges", "seqinr",
              "readxl")
...
termseq_ecoli <- read_excel("/Users/felix/Desktop/nanopore_native_rna/data/additional_data/gky274_supplemental_files.xlsx",skip = 11) %>%
